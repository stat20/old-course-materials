...
Questions 4 - 7 can all be answered using data visualization. To lay the groundwork for an answering these questions using the survey data set, plan out your plots and set your expectations for what the data might look like. Please:
