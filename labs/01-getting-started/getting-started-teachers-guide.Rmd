...
- Introduce yourself to students as they enter and thank them for having their camera on.
...
- Gives students 1 min to write down 2 truths and 1 lie on a sheet of paper.
...
Click the green plus in the upper left corner to create a new file > R Markdown. Switch to pdf output and change the title to "Lab 1 Getting Started". After the file is created, then click the save button, and title it "01-getting-started". Save it in the labs folder to keep things tidy. Check the file tab to be sure it's in the right place (students will often get this wrong and not keep good track of files). Knit the pdf, then carefully go through each component of the Rmd and show what it turned into in the pdf - the header, the markdown text, the title/subtitle, r code, the plot. No need to get into too much detail about the structure of Rmd files now; we'll open Tuesday's lab with a more explicit discussion of that.
