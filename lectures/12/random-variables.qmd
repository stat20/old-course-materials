...
A random variable $X$ has a discrete uniform distribution if it has only two outcomes, 1 and 0, (known as "success" and "failure", respectively) and a probability of success $p$.

$$ X \sim \textrm{Unif}(a, b) $$
